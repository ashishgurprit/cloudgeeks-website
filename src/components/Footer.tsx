...
const Footer = () => {
  return (
    <footer className="bg-slate-800 py-16 border-t border-slate-700">
          ...
          <div className="flex flex-col items-center md:items-start space-y-6">
            ...
            <RouterLink to="/gts" className="group cursor-pointer">
              <img
                ...
                height={64}
                loading="lazy"
                className="h-16 w-auto opacity-90 group-hover:opacity-100 transition-opacity brightness-0 invert"
              />
            </RouterLink>
          ...
          <div className="flex flex-col items-center md:items-end space-y-6">
            <div className="flex gap-6">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="p-3 rounded-full bg-white/10 hover:bg-white text-white hover:text-slate-800 transition-all"
                aria-label="LinkedIn"
              >
